...
def get_transforms(transform_variant, out_size):
    # Import imgaug-backed transforms lazily so inference-only prediction on
    # modern Python/albumentations does not fail during module import.
    IAAAffine2 = None
    IAAPerspective2 = None
    if transform_variant.startswith('distortions'):
        from saicinpainting.training.data.aug import IAAAffine2 as _IAAAffine2, IAAPerspective2 as _IAAPerspective2
        IAAAffine2 = _IAAAffine2
        IAAPerspective2 = _IAAPerspective2
